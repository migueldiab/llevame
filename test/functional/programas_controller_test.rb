...
class ProgramasControllerTest < ActionController::TestCase
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post :create, programa: { fFin: @programa.fFin, fInicio: @programa.fInicio, idAgenda: @programa.idAgenda, nombre: @programa.nombre }
    end
  ...
  test "should update programa" do
    put :update, id: @programa, programa: { fFin: @programa.fFin, fInicio: @programa.fInicio, idAgenda: @programa.idAgenda, nombre: @programa.nombre }
    assert_redirected_to programa_path(assigns(:programa))
  end
