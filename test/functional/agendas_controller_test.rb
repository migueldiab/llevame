...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { idUsuario: @agenda.idUsuario, nombre: @agenda.nombre, publica: @agenda.publica }
    end
  ...
  test "should update agenda" do
    put :update, id: @agenda, agenda: { idUsuario: @agenda.idUsuario, nombre: @agenda.nombre, publica: @agenda.publica }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
